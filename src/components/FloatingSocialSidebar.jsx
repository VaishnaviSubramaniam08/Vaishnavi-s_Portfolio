...
const FloatingSocialSidebar = () => {
  const socials = [
    { name: 'WhatsApp', icon: <MessageCircle size={22} />, href: 'https://wa.me/919342557567', color: 'text-green-500 shadow-[0_0_20px_rgba(34,197,94,0.8)]' },
    { name: 'LinkedIn', icon: <Linkedin size={22} />, href: 'https://linkedin.com/in/vaishnavisubramaniam', color: 'text-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.8)]' },
    ...
    { name: 'Email', icon: <Mail size={22} />, href: 'mailto:vaishnavisubramaniam08@gmail.com', color: 'text-red-400 shadow-[0_0_20px_rgba(248,113,113,0.8)]' },
